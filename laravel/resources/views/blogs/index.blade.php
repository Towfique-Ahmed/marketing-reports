                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="8" class="text-center py-5 text-muted">
                            ...
                            No blog posts found. <a href="#" data-bs-toggle="modal" data-bs-target="#addModal">Add the first one.</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="bi bi-plus-circle me-2"></i>Add Blog Post</h5>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="title" class="form-control" required placeholder="Blog post title">
                        </div>
                        <div class="col-md-8">
                        ...
                        <div class="col-md-3">
                            <label class="form-label fw-medium">Rank</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-medium">AI Overview</label>
                            <input type="text" name="ai_overview" class="form-control" placeholder="AI overview snippet...">
                        </div>
                        <div class="col-12">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <label class="form-label fw-medium">Rank</label>
                            <input type="number" name="rank" id="edit_rank" class="form-control" min="0">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-medium">Keywords</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-medium">AI Overview</label>
                            <input type="text" name="ai_overview" id="edit_ai_overview" class="form-control">
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-medium">Notes</label>
...
<div class="modal fade" id="deleteModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-danger"><i class="bi bi-trash me-2"></i>Delete Blog Post</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <p>Are you sure you want to delete <strong id="delete_title"></strong>? This action cannot be undone.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('blogs.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <p class="text-muted small">CSV columns: <code>id, title, url, publish_date, month, year, views, rank, ai_overview, keywords, notes</code></p>
