...
@section('topbar-actions')
    <a href="{{ route('social.export', ['month'=>$month,'year'=>$year]) }}" class="btn btn-sm btn-outline-secondary">
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($post->fb_url)
                                <a href="{{ $post->fb_url }}" target="_blank" class="btn btn-sm btn-outline-secondary py-0 px-2">
                        ...
                        <td>
                            @if($post->linkedin_url)
                                <a href="{{ $post->linkedin_url }}" target="_blank" class="btn btn-sm btn-outline-secondary py-0 px-2">
                        ...
                        <td>
                            @if($post->twitter_url)
                                <a href="{{ $post->twitter_url }}" target="_blank" class="btn btn-sm btn-outline-secondary py-0 px-2">
                        ...
                        <td class="text-end text-nowrap">
                            <button class="btn btn-sm btn-outline-primary btn-edit"
                                ...
                                data-year="{{ $post->year }}"
                                data-fb_url="{{ $post->fb_url }}"
                                data-linkedin_url="{{ $post->linkedin_url }}"
                                data-twitter_url="{{ $post->twitter_url }}"
                    ...
                    <tr>
                        <td colspan="7" class="text-center py-5 text-muted">
                            <i class="bi bi-inbox fs-2 d-block mb-2"></i>No social posts found.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Social Post</h5>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="url" name="fb_url" class="form-control" placeholder="https://facebook.com/...">
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-medium"><i class="bi bi-linkedin me-1" style="color:#0077b5;"></i>LinkedIn URL</label>
                            <input type="url" name="linkedin_url" class="form-control" placeholder="https://linkedin.com/...">
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-medium"><i class="bi bi-twitter-x me-1"></i>Twitter/X URL</label>
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Social Post</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form id="editForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <label class="form-label fw-medium">Post Date</label>
                            <input type="date" name="post_date" id="edit_post_date" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-medium">Month</label>
                        ...
                        <div class="col-12">
                            ...
                            <input type="url" name="fb_url" id="edit_fb_url" class="form-control">
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <label class="form-label fw-medium">Twitter/X URL</label>
...
<div class="modal fade" id="importModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('social.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <p class="text-muted small">Columns: <code>id, title, post_date, month, year, fb_url, linkedin_url, twitter_url, notes</code></p>
